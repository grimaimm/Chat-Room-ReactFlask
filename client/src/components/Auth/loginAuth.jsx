...
const AuthLogin = ({ setUser }) => {
  ...
  return (
    <>
      <button onClick={signInWithGoogle} class="flex items-center gap-2 rounded-lg px-4 text-[15px] text-neutral-50 transition-all duration-300 w-full justify-center border !bg-white py-2.5 shadow-sm hover:scale-[101%] lg:w-fit false" data-umami-event="Sign In to Chat: Sign in with Google">
